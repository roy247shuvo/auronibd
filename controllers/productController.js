...
exports.getInventoryPage = async (req, res) => {
    try {
        ...
        res.render('admin/products/index', {
            ...
            types,
            work_types,
            nextSerial // <--- Pass this to the view
        });
    } catch (error) {
...
exports.saveProduct = async (req, res) => {
    ...
    try {
        ...
        const { 
            name, description, price, compare_price, sku, sales_channel, // Removed cost_price
        ...
        const [prodResult] = await conn.query(`
            ...
            (name, slug, description, regular_price, sale_price, cost_price, sku, sales_channel, brand_id, type_id, category_id, collection_id, work_type_id, fabric_id, stock_quantity)
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `, [
            name, 
